...
public class UserTypeUtils {
    ...
    private static final Set<Long> PERSONAL_IMPORTANT_SET = new HashSet<>();
    ...
    private static final Set<Long> PERSONAL_ALL_SET = new HashSet<>();
...
//            initSet(PERSONAL_IMPORTANT_SET, "uid_personal_important.csv");
//            initSet(PERSONAL_ALL_SET, "uid_personal_all.csv");
...
//    public static boolean isImportantUser(Long uid) {
//        if (uid == null) {
//            return false;
//        }
//        return PERSONAL_IMPORTANT_SET.contains(uid) || BLUE_V_SET.contains(uid);
//    }

//    public static boolean isUserExists(Long uid) {
//        if (uid == null) {
//            return false;
//        }
//        return PERSONAL_ALL_SET.contains(uid) || BLUE_V_SET.contains(uid);
//    }
