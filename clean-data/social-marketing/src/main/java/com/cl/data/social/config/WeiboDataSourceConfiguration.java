package com.cl.data.social.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.cl.data.social.mapper.weibo", sqlSessionTemplateRef = "weiboSqlSessionTemplate")
public class WeiboDataSourceConfiguration {
    ...
    public SqlSessionFactory sessionFactory(@Qualifier("weiboDataSource")DataSource dataSource) throws Exception {
        ...
        sessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath:mybatis/mapper/weibo/*.xml"));
        sessionFactoryBean.setConfigLocation(new PathMatchingResourcePatternResolver()
                .getResource("classpath:mybatis/mybatis-config.xml"));
        sessionFactoryBean.setTypeAliasesPackage("com.cl.data.social.entity");
