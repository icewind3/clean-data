 ...
 */
@Configuration
@MapperScan(basePackages = "com.cl.data.hbase.mapper.weibo", sqlSessionTemplateRef = "weiboSqlSessionTemplate")
public class WeiboDataSourceConfiguration {
    ...
    public SqlSessionFactory sessionFactory(@Qualifier("weiboDataSource")DataSource dataSource) throws Exception {
        ...
        sessionFactoryBean.setTypeAliasesPackage("com.cl.data.hbase.entity");
